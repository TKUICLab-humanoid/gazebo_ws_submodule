...
// 	Points.Inverse_Uncontrol_PointR_X	= LIPM.step_point_rx_;
//     Points.Inverse_Uncontrol_PointR_Y	= LIPM.step_point_ry_;
//     Points.Inverse_PointR_Z				= LIPM.step_point_rz_;
//     Points.Inverse_PiontR_Thta			= LIPM.step_point_rthta_;
//     Points.Inverse_Uncontrol_PointL_X	= LIPM.step_point_lx_;
//     Points.Inverse_Uncontrol_PointL_Y	= LIPM.step_point_ly_;
//     Points.Inverse_PointL_Z				= LIPM.step_point_lz_;
//     Points.Inverse_PiontL_Thta			= LIPM.step_point_lthta_;
